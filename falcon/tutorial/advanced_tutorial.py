...
# Instead of importing a default ML model we use the 
...
atoms.calc = OTFCalculator(model = model,
                           calc = exact_calc,
...
""" Options for plotting your results after the MD simulation


from falcon.utils.analysis.simulation import plot_simulation

plot_simulation("MD.traj", "INSERT_FALCON_OUTPUTFILE.out")



from falcon.utils.analysis.rdf import plot_rdf
